...
tradeoffPointAffinity_dir = "{}/offlineAffinity".format(proj_dir)

# not varing stripe num 
key="{}_{}".format(ECN,BLKMB)
...
for node in clusternodes:
    ...
    line="<attribute><name>tradeoffpointAffinity.directory</name><value>"+tradeoffPointAffinity_dir+"</value></attribute>\n"
    content.append(line)
